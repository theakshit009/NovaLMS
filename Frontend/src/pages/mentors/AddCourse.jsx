            ...
            <div key={chapterIndex} className='bg-white border rounded-lg mb-4'>
              <div className='flex justify-between items-center p-4 border-b'>
                <div className='flex items-center'>
                  <img src={assets.dropdown_icon} width={14} alt="" className={`mr-2 cursor-pointer transition-all ${chapter.collapses && "-rotate-90"}`} />
                ...
                <div className=' p-4'>
                  {chapter.chapterContent.map((lecture, lectureIndex) => (
                    <div key={lectureIndex} className=' flex justify-between items-center mb-2'>
                      <span>
                        {lectureIndex + 1} {lecture.lectureTitle} - {lecture.lectureDutration} mins - <a href={lecture.lectureUrl} target='_blank' className=' text-green-700'>Link</a> - {lecture.isPreviewFree ? 'Free Preview' : 'Paid'}
                      </span>
              ...
              <div className='fixed inset-0 z-50 flex items-center justify-center backdrop-blur-sm bg-black/30 shadow-2xl'>
                <div className=' relative bg-white text-gray-700 p-4 rounded w-[90%] max-w-md'>
                  ...
                  <div className=' mb-2'>
                    ...
                    })} value={lectureDetails.lectureDutration} name="" id="" className=' mt-1 block w-full border rounded py-1 px-2' />
                  </div>
                   <div className=' mb-2'>
                    <p>Lecture URL</p>
                    <input type="text" onChange={(e) => setLectureDetails({
                  ...
                  <button type='button' className=' w-full bg-green-700 text-white px-4 py-2 rounded'>Add</button>
